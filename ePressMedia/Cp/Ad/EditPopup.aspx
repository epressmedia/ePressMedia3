<%@ Page Title="" Language="C#" MasterPageFile="~/Cp/Master.master" AutoEventWireup="true" Inherits="Cp_Ad_EditPopup" Codebehind="EditPopup.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
  ...
  <h1>팝업 수정</h1>
  <asp:Label ID="PopupId" runat="server" Visible="False" />
  <br />
  <table width="600px">
    <tr>
      <td class="label">
    ...
    <tr>
      <td class="label">
        링크 주소</td>
      <td class="data">
        <asp:TextBox ID="LinkUrl" runat="server" Width="400px" MaxLength="128" />
        <br />
  ...
  <div class="cntr cmdPnl"> 
    <asp:Button runat="server" ID="SaveButton" Text="저장" Width="120px" onclick="AddButton_Click" />
  </div>
