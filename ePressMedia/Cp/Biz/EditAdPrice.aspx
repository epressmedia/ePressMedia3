<%@ Page Title="" Language="C#" MasterPageFile="~/Cp/Master.master" AutoEventWireup="true" Inherits="Cp_Biz_EditAdPrice" Codebehind="EditAdPrice.aspx.cs" %>
...
<h1>광고 단가 변경</h1>
  ...
  <div class="cmdPnl">
    <asp:Button ID="SaveButton" runat="server" Text="단가 변경 저장" 
