...
public partial class Article_ViewArticle : EPM.Core.EPMBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (cat > 0)
            {
                ...
                LoadPageControls(cat, ContentTypes.Article, UseForTypes.DetailView);
            }
    ...
    protected override void OnPreInit(EventArgs e)
    {
        try
        {
            ...
            string xml_setting = (context.ArticleCategories.Single(a => a.ArtCatId == cat)).DetailMetadataStr;
