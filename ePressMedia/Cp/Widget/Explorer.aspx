<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Explorer.aspx.cs" Inherits="ePressMedia.Cp.Widget.Explorer" %>
...
<body>
    ...
    <telerik:RadFileExplorer runat="server" ID="FileExplorer1" Width="530" Height="500"
        ...
        <Configuration ViewPaths="~/Controls" SearchPatterns="*.ascx" />
