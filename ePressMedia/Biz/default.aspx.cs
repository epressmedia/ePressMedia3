...
{
    public partial class BizDirectory : EPM.Core.EPMBasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                LoadPageControls(0, ContentTypes.Biz, UseForTypes.ListView);
        ...
        //        string xml_setting = (context.BusinessEntityConfigs.Single(a => 1 == 1)).MetadataStr;
