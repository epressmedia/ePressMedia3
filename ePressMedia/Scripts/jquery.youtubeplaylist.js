        ...
        init: function () {
            ...
            $(self.element).find('li').each(function (index) {
                ...
                listItem.find('a:first').each(function () {
                    ...
                    var replacedText = htmlEntities(listItem.text());
                    ...
                    if (ytid) {
                        ...
                        if (self.options.addThumbs) {
                            ...
                            /// Modified by Justin Lee @ Future-it.ca to apply CSS to the text
                            link.empty().html(thumbHtml + "<div>"+replacedText+"</div>").attr('title', replacedText);
