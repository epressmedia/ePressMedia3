...
namespace EPM.ImageLibrary
{
    ...
    public class EPMImage : IDisposable {
        ...
        /// <summary>
        /// Create a EPMImage from a System.Drawing.Image.
        /// </summary>
        /// <param name="image"></param>
        public EPMImage(Image image) {
            _image = image;
            _g = Graphics.FromImage(_image);
        }

        /// <summary>
        /// Create a EPMImage with a defined width and height.
        /// </summary>
        /// <param name="width"></param>
        /// <param name="height"></param>
        public EPMImage(int width, int height) {
            CreateImage(width, height);
        }

        /// <summary>
        /// Create a EPMImage with a defined width, height and backgroundcolor.
        /// </summary>
        /// <param name="width"></param>
        /// <param name="height"></param>
        /// <param name="bgcolor"></param>
        public EPMImage(int width, int height, Color bgcolor) {
        ...
        /// <summary>
        /// Create a EPMImage by loading an image from either local disk or web.
        /// </summary>
        /// <example>
        /// Open a local image:
        ///     EPMImage image = new EPMImage("c:\\images\\test.jpg");
        /// 
        /// Load an image from the web:
        ///     EPMImage image = new EPMImage("http://yourdomain.com/test.jpg");
        /// </example>
        /// <param name="filepath">Local filepath or internet URL</param>
        public EPMImage(string filepath) {
        ...
        /// <summary>
        /// Create a EPMImage from a stream.
        /// </summary>
        /// <param name="stream"></param>
        public EPMImage(Stream stream) {
            LoadImage(stream);
        }
        ...
        /// <summary>
        /// Create an exact copy of this Kaliko.ImageLibrary.EPMImage
        /// </summary>
        /// <returns></returns>
        public EPMImage Clone() {
            // Create new image from the old one
            EPMImage newImage = new EPMImage(_image);
        ...
        /// <example>
        /// EPMImage image = new EPMImage(200, 200);
        ...
        public EPMImage GetThumbnailImage(int width, int height) {
            return GetThumbnailImage(width, height, ThumbnailMethod.Crop);
        }


        public EPMImage GetThumbnailImage(int width, int height, ThumbnailMethod method) {
            EPMImage image;
            ...
            if(method == ThumbnailMethod.Crop ) {
                ...
                image = new EPMImage(width, height);
                ...
                image = new EPMImage(width, height, Color.White);// _backgroundColor);
                DrawScaledImage(image._image, _image, (width - imgWidth) / 2, (height - imgHeight) / 2, imgWidth, imgHeight);
            }
        ...
        public void BlitImage(EPMImage image) {
            BlitImage(image._image, 0, 0);
        }


        public void BlitImage(EPMImage image, int x, int y) {
        ...
        public void BlitFill(EPMImage image) {
