<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PostEvent.ascx.cs" Inherits="ePressMedia.Calendar.Controls.PostEvent" %>
    ...
    <tr>
      ...
      <td class="data">
        ...
        <asp:RequiredFieldValidator ID="Req7" runat="server" ControlToValidate="Password"
          ErrorMessage=" * 필수항목" Display="Dynamic" />
        <br />
        내용 수정시에 필요합니다 (최대 8자)
        </td>
    </tr>
    <tr>
      ...
      <td class="data">
        ...
        <asp:RequiredFieldValidator ID="SubjectReq" runat="server" ControlToValidate="EventTitle" 
            Display="Dynamic" ErrorMessage=" * 필수항목" />
      </td>
    </tr>
    <tr>
